...
public class TvShowsPopcornProvider extends MediaProvider {

    private static Integer CURRENT_API = 0;
    private static final String[] API_URLS = {"http://tv-v2.api-fetch.website/"};
    ...
    private static final MediaProvider sMediaProvider = new TvShowsPopcornProvider();
    ...
    public Call getList(final ArrayList<Media> existingList, Filters filters, final Callback callback) {
        ...
        Timber.d("TvShowsPopcornProvider", "Making request to: " + url);
    ...
    public List<NavInfo> getNavigation() {
        ...
        tabs.add(new NavInfo(R.id.popcorn_filter_last_updated,Filters.Sort.DATE, Filters.Order.DESC, ButterApplication.getAppContext().getString(R.string.last_updated),R.drawable.popcorn_filter_last_updated));
        ...
        tabs.add(new NavInfo(R.id.popcorn_filter_a_to_z,Filters.Sort.ALPHABET, Filters.Order.DESC, ButterApplication.getAppContext().getString(R.string.a_to_z),R.drawable.popcorn_filter_a_to_z));
        return tabs;
    }
